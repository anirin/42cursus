...
/*   Updated: 2023/07/05 02:10:31 by atokamot         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    if (ft_strcmp(str, "pa\n") == 0)
        push(&lists->sub_list_a, &lists->sub_list_b, C, &lists->sub_swap_result);
    if (ft_strcmp(str, "pb\n") == 0)
        push(&lists->sub_list_b, &lists->sub_list_a, C, &lists->sub_swap_result);
}
